...
import lombok.*;
import org.frikadelki.ash.telegram.api.keyboard.builders.TgmReplyKeyboardMarkupBuilder;
...
public final class TgmReplyKeyboardMarkup {
	...
	public static TgmReplyKeyboardMarkupBuilder builder() {
		return TgmReplyKeyboardMarkupBuilder.make();
	}

	/**
	 * Required. Array of button rows, each represented by an Array of KeyboardButton objects
	 */
	@Getter @Setter @NonNull private List<List<TgmKeyboardButton>> keyboard;
	...
	@Getter @Setter private Boolean resizeKeyboard = null;
	...
	@Getter @Setter private Boolean oneTimeKeyboard = null;
	 ...
	 */
	@Getter @Setter private Boolean selective = null;
}
